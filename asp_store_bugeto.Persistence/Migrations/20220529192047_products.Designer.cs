...
namespace asp_store_bugeto.Persistence.Migrations
{
    ...
    [Migration("20220529192047_products")]
            ...
            modelBuilder.Entity("asp_store_bugeto.Domain.Entities.Commons.Temp", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2022, 5, 29, 12, 20, 46, 881, DateTimeKind.Local).AddTicks(921),
                            IsRemoved = false,
            ...
            modelBuilder.Entity("asp_store_bugeto.Domain.Entities.Emails.SenderEmail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertTime = new DateTime(2022, 5, 29, 12, 20, 46, 880, DateTimeKind.Local).AddTicks(7288),
                            IsRemoved = false,
                            Password = "1111"
                        });
                });
