...
namespace asp_store_bugeto.Persistence.Migrations
{
    ...
    [Migration("20220706185838_AddHomePageSliders")]
            ...
            modelBuilder.Entity("asp_store_bugeto.Domain.Entities.Commons.Temp", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2022, 7, 6, 11, 58, 37, 339, DateTimeKind.Local).AddTicks(8976),
                            IsRemoved = false,
                        ...
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2022, 7, 6, 11, 58, 37, 340, DateTimeKind.Local).AddTicks(1124),
                            IsRemoved = false,
            ...
            modelBuilder.Entity("asp_store_bugeto.Domain.Entities.Emails.SenderEmail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertTime = new DateTime(2022, 7, 6, 11, 58, 37, 339, DateTimeKind.Local).AddTicks(5192),
                            IsRemoved = false,
                            Password = "1111"
                        });
                });
            ...
            modelBuilder.Entity("asp_store_bugeto.Domain.Entities.HomePage.SliderCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountItem = 6,
                            InsertTime = new DateTime(2022, 7, 6, 11, 58, 37, 340, DateTimeKind.Local).AddTicks(3626),
                            IsRemoved = false
                        },
                        new
                        {
                            ...
                            CountItem = 6,
                            InsertTime = new DateTime(2022, 7, 6, 11, 58, 37, 340, DateTimeKind.Local).AddTicks(6000),
                            IsRemoved = false
                        },
                        new
                        {
                            ...
                            CountItem = 6,
                            InsertTime = new DateTime(2022, 7, 6, 11, 58, 37, 340, DateTimeKind.Local).AddTicks(6093),
                            IsRemoved = false
                        },
                        new
                        {
                            ...
                            CountItem = 6,
                            InsertTime = new DateTime(2022, 7, 6, 11, 58, 37, 340, DateTimeKind.Local).AddTicks(6149),
                            IsRemoved = false
                        });
                });
