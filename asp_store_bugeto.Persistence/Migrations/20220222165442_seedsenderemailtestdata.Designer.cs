...
namespace asp_store_bugeto.Persistence.Migrations
{
    ...
    [Migration("20220222165442_seedsenderemailtestdata")]
    partial class seedsenderemailtestdata
    {
            ...
            modelBuilder.Entity("asp_store_bugeto.Domain.Entities.Emails.SenderEmail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertTime = new DateTime(2022, 2, 22, 8, 54, 42, 145, DateTimeKind.Local).AddTicks(2439),
                            IsRemoved = false,
                            Password = "1111"
                        });
                });
