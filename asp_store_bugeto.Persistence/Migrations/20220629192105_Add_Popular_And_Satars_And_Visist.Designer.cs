...
namespace asp_store_bugeto.Persistence.Migrations
{
    ...
    [Migration("20220629192105_Add_Popular_And_Satars_And_Visist")]
    partial class Add_Popular_And_Satars_And_Visist
    {
            ...
            modelBuilder.Entity("asp_store_bugeto.Domain.Entities.Commons.Temp", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2022, 6, 29, 12, 21, 4, 442, DateTimeKind.Local).AddTicks(4890),
                            IsRemoved = false,
            ...
            modelBuilder.Entity("asp_store_bugeto.Domain.Entities.Emails.SenderEmail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertTime = new DateTime(2022, 6, 29, 12, 21, 4, 442, DateTimeKind.Local).AddTicks(755),
                            IsRemoved = false,
                            Password = "1111"
                        });
                });
