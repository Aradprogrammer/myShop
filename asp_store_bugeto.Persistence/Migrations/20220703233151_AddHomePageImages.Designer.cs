...
namespace asp_store_bugeto.Persistence.Migrations
{
    ...
    [Migration("20220703233151_AddHomePageImages")]
            ...
            modelBuilder.Entity("asp_store_bugeto.Domain.Entities.Commons.Temp", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2022, 7, 3, 16, 31, 50, 545, DateTimeKind.Local).AddTicks(8381),
                            IsRemoved = false,
                        ...
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2022, 7, 3, 16, 31, 50, 545, DateTimeKind.Local).AddTicks(9674),
                            IsRemoved = false,
            ...
            modelBuilder.Entity("asp_store_bugeto.Domain.Entities.Emails.SenderEmail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertTime = new DateTime(2022, 7, 3, 16, 31, 50, 545, DateTimeKind.Local).AddTicks(1932),
                            IsRemoved = false,
                            Password = "1111"
                        });
                });
